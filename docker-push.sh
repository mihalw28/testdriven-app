...
then
  ...
  if [[ "$TRAVIS_BRANCH" == "staging" ]]; then
    ...
    export REACT_APP_USERS_SERVICE_URL="http://testdriven-staging-alb-735455032.us-east-1.elb.amazonaws.com"
    export REACT_APP_EXERCISES_SERVICE_URL="http://testdriven-staging-alb-735455032.us-east-1.elb.amazonaws.com"
  elif [[ "$TRAVIS_BRANCH" == "production" ]]; then
    export DOCKER_ENV=prod
    export REACT_APP_USERS_SERVICE_URL="http://testdriven-production-alb-222827923.us-east-1.elb.amazonaws.com"
    export REACT_APP_EXERCISES_SERVICE_URL="http://testdriven-production-alb-222827923.us-east-1.elb.amazonaws.com"
