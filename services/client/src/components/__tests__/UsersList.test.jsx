...
const users = [
    ...
    },
    {
        'active': true,
        'admin': false,
        'email': 'michalwaszak@email.com',
        'id': 2,
        'username': 'michalwaszak'
    },
];
...
test('UsersList renders properly', () => {
    ...
    expect(td.get(1).props.children).toBe('michal@tomek.com');
    expect(td.get(2).props.children).toBe('tomek');
